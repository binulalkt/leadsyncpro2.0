...
export default function AddLeadDrawer({ open, onClose, onSave }) {
  ...
  return (
    <>
      ...
      <div style={{
        position: 'fixed', top: 0, right: 0, bottom: 0, width: isMobile ? '100%' : 380,
        ...
        <div style={{ padding: '13px 16px', borderBottom: '1px solid var(--bd)',
          ...
          <div>
            ...
            <div style={{ fontFamily: 'var(--mono)', fontSize: 9, color: 'var(--t3)', marginTop: 2 }}>
              Saved to Cloud Firestore database
            </div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 14 }}>
            <div>
              <div className="field-label">Name <span style={{ color: 'var(--t3)' }}>(optional)</span></div>
