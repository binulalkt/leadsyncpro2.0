...
const COURSES = ['Data Science','MERN Stack','Flutter Dev','UI/UX Design','Digital Marketing',
  'Ethical Hacking','Python Full Stack','Cloud Computing','Machine Learning','React Native','DevOps','Java Full Stack'];
...
export default function LeadDetail({ onDial }) {
  ...
  const saveEdit = async () => {
    ...
    updateLeadInStore(lead.id, editForm);
    setSelectedLead({ ...lead, ...editForm });
